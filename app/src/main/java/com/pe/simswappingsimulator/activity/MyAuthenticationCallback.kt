...
class MyAuthenticationCallback(private val context: Context,private val listener: AuthenticationResultListener) : FingerprintManager.AuthenticationCallback() {
